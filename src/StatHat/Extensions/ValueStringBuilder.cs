...
internal ref struct ValueStringBuilder
{
    ...
    public void Append(int value)
    {
        ...
        {
            Span<char> v = stackalloc char[12];

            value.TryFormat(v, out int length, provider: CultureInfo.InvariantCulture);

            v.Slice(0, length).CopyTo(AppendSpan(length));
        }
    }
    ...
    public void Append(long value)
    {
        ...
        {
            Span<char> v = stackalloc char[20];
